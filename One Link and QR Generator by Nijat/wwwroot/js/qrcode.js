...
(function () {
	...
	var svgDrawer = (function() {
		...
		Drawing.prototype.draw = function (oQRCode) {
			...
			var svg = makeSVG("svg" , {'viewBox': '0 0 ' + String(nCount + 2 * _htOption.border) + " " + String(nCount + 2 * _htOption.border), 'width': '100%', 'height': '100%', 'fill': _htOption.colorLight});			svg.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink", "http://www.w3.org/1999/xlink");
			_el.appendChild(svg);
